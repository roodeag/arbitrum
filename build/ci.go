...
func buildFlags(env build.Environment, staticLinking bool, buildTags []string) (flags []string) {
	var ld []string
	if env.Commit != "" {
		ld = append(ld, "-X", "github.com/roodeag/arbitrum/internal/version.gitCommit="+env.Commit)
		ld = append(ld, "-X", "github.com/roodeag/arbitrum/internal/version.gitDate="+env.Date)
	}
