...
```shell
go get github.com/roodeag/arbitrum/cmd/checkpoint-admin
```
...
*CHECKPOINT_HASH is obtained based on this [calculation method](https://github.com/roodeag/arbitrum/blob/master/params/config.go#L251).*
