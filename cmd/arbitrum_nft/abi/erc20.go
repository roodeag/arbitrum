...
func (_Abi *AbiCaller) BalanceOf(opts *bind.CallOpts, who common.Address) (*big.Int, error) {
	var out []interface{}
	err := _Abi.contract.Call(opts, &out, "balanceOf", who)
...
//
// Solidity: function balanceOf(address who) view returns(uint256)
func (_Abi *AbiSession) BalanceOf(who common.Address) (*big.Int, error) {
	return _Abi.Contract.BalanceOf(&_Abi.CallOpts, who)
}

// BalanceOf is a free data retrieval call binding the contract method 0x70a08231.
//
// Solidity: function balanceOf(address who) view returns(uint256)
func (_Abi *AbiCallerSession) BalanceOf(who common.Address) (*big.Int, error) {
	return _Abi.Contract.BalanceOf(&_Abi.CallOpts, who)
}
